...
const App = () => {
    ...
    const loadData = async (filterOption) => await FetchService.getProducts().then(async () => setData(await FetchService.fetchData(filterOption)))
    const getData = async (filterOption) => setData(await FetchService.fetchData(filterOption))
